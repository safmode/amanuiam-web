...
export const DecisionModal = ({ open, onClose, onYes, onNo, alert, formatDate }) => {
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[450px] rounded-xl p-0 overflow-hidden bg-white dark:bg-slate-800 dark:border-slate-700">
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="bg-white rounded-lg p-3 border border-gray-200 dark:bg-slate-800/50 dark:border-slate-700">
              ...
              {alert.assigned_officer_name && (
                <div className="flex items-center gap-2 text-sm mt-1">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">
                    Responding Officer: {alert.assigned_officer_name}
                  </span>
                </div>
              )}
              <div className="flex items-center gap-2 text-sm mt-1">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Button
              className="flex-1 bg-[#D4A853] hover:bg-[#C49A48] text-white rounded-lg gap-2 h-10 text-sm font-medium"
              onClick={onYes}
            >
